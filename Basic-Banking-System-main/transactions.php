...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics\goku.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="statics\goku.jpg">
    <link rel="icon" type="image/png" sizes="16x16" href="statics\goku.jpg">
...
<body style="background-color:#212529;">
    ...
    <img src=" statics\ultra_instinct_goku.jpg  " alt="" style="width:100%;position:absolute; z-index:-1">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\goku.jpg" alt=""
