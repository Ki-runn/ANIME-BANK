...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/kiran.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="statics/kiran.jpg ">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/kiran.jpg ">
    ...
    <title>About us - anime Bank</title>
...
<body style="background-color:#212529;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics/kiran.jpg" alt=""
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/kiran.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;"> Kiran TR</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> EAST POINT College of Engineering, banglore</b></p>
    </center>
