...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics\TANJIRO.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="statics\TANJIRO.jpg ">
    <link rel="icon" type="image/png" sizes="16x16" href="statics\TANJIRO.jpg">
    ...
    <title>All customers - anime Bank</title>
...
<img src=" statics\kyujiro.jpg  " alt="" style="width:100%;position:absolute; z-index:-1">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\TANJIRO.jpg  " alt=""
