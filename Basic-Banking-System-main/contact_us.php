...
<head>
    ...
    <title>Contact us - anime Bank</title>
</head>

<body style="background-image:url('statics/5570834-min.jpg'); padding-top:8%;">
    <?php include 'spin.php'; ?>

      <img src=" statics\haha.jpg   " alt="" style="width:100%;position:absolute; z-index:-1">
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            ...
            <div class="container"
                style=" backdrop-filter: blur(1px);  border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
