...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href=" statics\gojo.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="statics\gojo.jpg">
    <link rel="icon" type="image/png" sizes="16x16" href="statics\gojo.jpg">
    ...
    <title>Welcome to anime bank  </title>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\gojo.jpg " alt=""
    ...
    <div class="container-large"
        style="color:white; height:10px; width: 100%; padding:8% 2% 2% 2%; background-color: #0763c0;">
        <div class="row">
    ...
    <img src=" statics\anime_gojo.jpg" alt="" style="width:100%;position:absolute; z-index:-1">

    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(1px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b> WELCOME TO ANIME BANK</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px blue; padding:20px 10px 20px 10px;">
                            ...
                            <h6> you can list all the customers here.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6> money transactions happen here.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
